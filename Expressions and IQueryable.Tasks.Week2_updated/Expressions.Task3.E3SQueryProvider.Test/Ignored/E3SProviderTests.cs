...
namespace Expressions.Task3.E3SQueryProvider.Test.Ignored
{
    ...
    public class E3SProviderTests
    {
        ...
        {
            IEnumerable<EmployeeEntity> res = searchService.Value.SearchFts<EmployeeEntity>(new List<string> { "workstation:(EPRUIZHW0249)" }, 0, 1);
        ...
        {
            var res = searchService.Value.SearchFts(typeof(EmployeeEntity), new List<string> { "workstation:(EPRUIZHW0249)" }, 0, 10);
